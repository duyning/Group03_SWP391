...
public class VoucherRepository {
    ...
    public List<Voucher> findAllPaged(int page, int size) {
        ...
        org.hibernate.query.Query<Voucher> query = session.createQuery(hql, Voucher.class);
    ...
    public long countAll() {
        Session session = sessionFactory.getCurrentSession();
        return (Long) session.createQuery("SELECT count(v) FROM Voucher v", Long.class).uniqueResult();
    }
